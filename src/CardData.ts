...
export const allCards: Readonly<Card[]> = [
  ...
  new Card(54, 2, 'Gewitterring', CardType.Einfluss, 'VIOLET', 'Der ausgerüstete Charakter erhält Flug und +X/+0, wobei X der Anzahl Aktionen in deinem Lazarett entspricht.'),
  ...
  new Card(65, 1, 'Schwereloser Bogen', CardType.Einfluss, 'WHITE', 'Der ausgerüstete Charakter hat +2/+0. Jedes Mal, wenn der ausgerüstete Charakter angreift, dünne 2 Karten aus.'),
  ...
  new Card(121, 3, 'Wurzelspeer', CardType.Einfluss, 'GREEN', 'Der ausgerüstete Charakter erhält +6/+2, Durchbruch und Lebensraub.  2.8, ®: Ausrüsten.'),
  ...
  new Card(133, 2, 'Buch der Natur', CardType.Einfluss, 'GREEN', 'Der ausgerüstete Charakter erhält +X/+X, wobei X den Lebenspunkten entspricht, die du in diesem Zug erhalten hast.  18, ®: Ausrüsten.'),
  ...
  new Card(147, 2, 'Radiumherz', CardType.Einfluss, 'BROWN', 'Der ausgerüstete Charakter erhält +2/+2. Jedes Mal, wenn er angreift, lege die oberste Karte deines Decks verdeckt und erschöpft als Macht ins Spiel.  2 8, ®: Ausrüsten.'),
  ...
  new Card(154, 2, 'Hartstein Hammer', CardType.Einfluss, 'BROWN', 'Der ausgerüstete Charakter erhält +X/+X, wobei X die Anzahl an Macht ist, die du kontrollierst.'),
